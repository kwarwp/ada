...
def main():
    ...
    cylinder(pos=(0, 0, 30), size=(80, 80, 30), axis=(0, 0, 1), texture="https://i.imgur.com/IPcmVFnb.jpg")
    box(pos=(100, 100, 30), size=(80, 80, 30), texture="https://i.imgur.com/d5fWaoab.jpg")
