...
AttributeError: 'gameInicio' object has no attribute 'musA'
'''},
{'date': 'Mon Dec 30 2019 14:50:18.186 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
NameError: name 'cena' is not defined
'''},
{'date': 'Mon Dec 30 2019 14:56:48.748 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 277
    Controlador()
  module <module> line 272
    self.toca()
  module <module> line 179
    self.musA.x = -1200
AttributeError: 'Controlador' object has no attribute 'musA'
'''},