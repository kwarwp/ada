...
window2 = Elemento(window_2,style=dict(left=540,top=-45,width="420px",height="590px",overflow="hidden"))
window2.img.style=dict(position="relative",right="-230px")
torch = Elemento(torch_,style=dict(left=-100,top=-5,width="600px",height="400px"))
...
door = Elemento(door,style=dict(left=10,top=7,width="950px",height="612px"))
