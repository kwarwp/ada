...
class gameInicio:
    ...
    def elevador(self, ev=0):
        ...
        self.foguinho1 = Elemento(FOGO, x=440, y=450,w=150,h=100, cena=todos, vai=self.sobe_desce)
        self.foguinho2 = Elemento(FOGO, x=700, y=450,w=150,h=100, cena=todos, vai=self.sobe_desce)
        
        self.foguim1 = Elemento(FOGUI, x=550, y=250,w=50,h=50, cena=todos, vai=self.sobe_desce)        
        self.foguim2 = Elemento(FOGUI, x=750, y=280,w=50,h=50, cena=todos, vai=self.sobe_desce) 
        self.foguim3 = Elemento(FOGUI, x=600, y=280,w=50,h=50, cena=todos, vai=self.sobe_desce) 
